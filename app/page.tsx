...
import { attachHeroVideo } from "@/lib/hero-video";
...
export default function Home() {
  ...
  return <main>
    ...
    <section id="inicio" className="hero" aria-labelledby="hero-title">
      ...
      <div className="hero-art" aria-hidden="true"><video ref={heroVideoRef} autoPlay muted loop playsInline controls={false} preload="auto" disablePictureInPicture disableRemotePlayback tabIndex={-1} poster="/images/hero-video-poster.webp" src="/videos/hero-go-sinalizacao-silent.mp4" /><div className="hero-photo-shade" /><div className="art-caption"><Image src="/images/go-sinalizacao-transparent.png" alt="" width={116} height={77} /><p>Precisão técnica<br />em cada entrega.</p></div></div>
    </section>
